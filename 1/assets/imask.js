(function(global, factory) {
        ...
        _createClass(PatternCursor, [{
            ...
            },
            {
                ...
                value: function _pushRight(fn) {
                    this.pushState();
                    for (
                        this.bindBlock(); this.index < this.masked._blocks.length;
                ...
                value: function _forEachBlocksInRange(fromPos) {
                    ...
                    if (fromBlockIter) {
                        ...
                        if (toBlockIter && !isSameBlock) {
                            ...
                            for (
                                var bi = fromBlockIter.index + 1; bi < toBlockIter.index;
                                ++bi
                            ) {
            ...
            },
            {
                ...
                value: function doPrepare(ch) {
                    ...
                    ch = this._removeThousandsSeparators(
                        this.scale && this.mapToRadix.length && flags.raw ?
    ...
    MaskedNumber.EMPTY_VALUES = [].concat(
        _toConsumableArray(Masked.EMPTY_VALUES), [0]
    );
